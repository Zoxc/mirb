...
rt_value rt_nilclass_to_s(rt_value obj, unsigned int argc)
{
	return rt_string_from_cstr("nil");
}

rt_value rt_trueclass_to_s(rt_value obj, unsigned int argc)
{
	return rt_string_from_cstr("true");
}

rt_value rt_falseclass_to_s(rt_value obj, unsigned int argc)
{
