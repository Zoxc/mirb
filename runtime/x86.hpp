...
#else
	extern void rt_support_call() mirb_external("rt_support_call");
	extern void rt_support_super() mirb_external("rt_support_super");
#endif

rt_value rt_support_get_ivar(void);
void __stdcall rt_support_set_ivar(rt_value value);

void __noreturn __stdcall rt_support_return(rt_value value, void *target);
void __noreturn __stdcall rt_support_break(rt_value value, void *target, size_t id);
