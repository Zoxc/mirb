	...
	namespace CodeGen
	{
		...
		class ByteCodeGenerator
		{
			private:
				...
				void convert_interpolate(Tree::Node *basic_node, var_t var);
				...
				void convert_block(Tree::Node *basic_node, var_t var);
				...
				void to_bytecode(Tree::Node *node, var_t var)
				{
					...
					auto func = jump_table[node->type()];
					
					mirb_debug_assert(func);
