...
get_node_name_proc get_node_name_procs[] = {name_unary_op, name_binary_op, name_num, name_var, name_ivar, name_ivar_assign, name_string, name_string_start, name_string_continue, name_array, name_array_element, name_const, name_self, name_true, name_false, name_nil, name_assign, name_assign_const, name_boolean, name_not, name_no_equality, name_if, name_if, name_argument, name_call_arguments, name_call, name_array_call, name_expressions, name_class, name_module, name_scope, name_method};
